...
namespace DribbbleForWindowsPhone.Common
{
    ...
    /// </code>
    /// 
    /// 2) RegisterViewModels the page to call into the NavigationHelper whenever the page participates 
    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        /// <summary>
        /// RegisterViewModels this event on the current page to populate the page
        ...
        /// <summary>
        /// RegisterViewModels this event on the current page to preserve
